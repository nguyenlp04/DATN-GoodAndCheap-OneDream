            ...
            <div class="container">
                <div class="row d-flex justify-content-Start">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        ...
                                        <img src="{{ asset($channels->image_channel) }}"
                                            alt="{{ $channels->image_channel }}" class="img-fluid"
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p style="color: #ff0000;"><i class="fa-solid fa-handshake"
                                        ...
                                        <div class="d-flex justify-content-start rounded-3 p-2 mb-md-2 bg-body-tertiary  "
                                            ...
                                            <div class="mx-3">
                                                <p class="small text-muted "> <i class="fa-solid fa-location-dot"
                                                        style="color: #74C0FC;"></i> {{ $channels->address }} </p>
                                                <p class="small text-muted"><i class="fa-solid fa-clock"
                                                        style="color: #74C0FC;"></i>
                                                    {{ $channels->created_at->format('d-m-Y') }}</p>
                                            ...
                                            <div>
                                                <p class="small text-muted "><i class="fa-solid fa-users"
                                                        style="color: #74C0FC;"></i> {{ $channels->followers_count }}
                                                </p>
                    ...
                    <div class="col col-md-9 col-lg-7 col-xl-6 d-flex justify-content-end">
                        @if ($isFollowed)
                        <form id="unfollow-form" action="{{ route('unfollow.channel', $channels->channel_id) }}"
                            method="POST">
                            @csrf @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-rounded mt-md-3 mx-md-3"
                                style="height: 50px"><i class="fa-solid fa-user-minus me-2"></i>Unfollow</button>
                        </form>
                        @else
                        <form id="follow-form" action="{{ route('follow.channel', $channels->channel_id) }}"
                            method="POST">
                            @csrf
