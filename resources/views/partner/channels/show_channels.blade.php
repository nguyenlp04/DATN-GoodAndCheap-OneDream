                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        ...
                                        @else
                                            <img src="https://png.pngtree.com/png-vector/20220114/ourmid/pngtree-2-5d-vegetable-market-stall-stall-bazaar-vector-design-elements-png-image_4172096.png"
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p style="color: #ff0000;position: relative; top:-8px;" class="d-none d-md-block">
                                        <i class="fa-solid fa-handshake" style="color: #FFD43B;"></i>
                                        ...
                                        <div class="d-flex justify-content-start rounded-3 p-2 mb-md-2 bg-body-tertiary  "
                                            ...
                                            <div class="mx-1">
                                                <p class="small text-muted mb-2 mb-md-0"  style="white-space: nowrap;"><i class="fa-solid fa-users"
                                                        style="color: #74C0FC;"></i> {{ $channel->followers_count }} </p>
                                               <p class="small text-muted" style="white-space: nowrap;">
                                                    <i class="fa-solid fa-clipboard-check" style="color: #74C0FC;"></i> {{ $NewsCount }}
                                                </p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product-body product-action-inner">
                                                                ...
                                                                <div class="product-content wrap">
                                                                    <p class="text-truncate">{{ $sale_new->description }}
                                                                    </p>
                                                                </div>
