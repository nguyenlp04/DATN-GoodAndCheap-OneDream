            ...
            <div class="col-md-12 mb-4">
                @if($channels)
                    ...
                    <div class="channel-info d-flex align-items-center p-3 border rounded-2 shadow-sm bg-light">
                        <!-- Channel Image -->
                        <a href="{{ route('channels.show',['channel' => $channels->channel_id]) }}">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="text-muted">
                                ...
                                <span class="text-danger">
                                    <i class="bi bi-star-fill text-warning"></i> {{ $channels->rating }} 123 Đánh Giá
                                </span> 
                            </div>
                ...
                @else
                    <div class="alert alert-warning">
                        Không tìm thấy kênh cho người dùng này.
                    </div>
                @endif
            </div>
            ...
            <div class="container for-you">
                <div class="heading heading-flex mb-3">
                    ...
                    <div class="heading-right">
                        <a href="#" class="title-link">View All Recommended <i class="icon-long-arrow-right"></i></a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 border">
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/demos/demo-4/products/product-10.jpg') }}" alt="{{ $product->name_product }}">
                                            </a>
