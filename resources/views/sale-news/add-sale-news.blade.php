                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <div class="">
                                ...
                                <div class="card-body rounded" style="border-style: dashed;">
                                    <div class="dropzone p-0 dz-clickable" style="display: flex; justify-content: center; align-items: center; flex-direction: column; height: 17.5rem;">
                        ...
                        <aside class="col-lg-3">
                            ...
                            <div>
                                ...
                                <input type="number" class="form-control" placeholder="Price" name="price" aria-label="Product price" required>
                                ...
                                <div class="mb-3" id="subcategory-section" style="display: none;">
                                    <label for="subcategory" class="font-weight-bold form-label">SubCategory Name:</label>
