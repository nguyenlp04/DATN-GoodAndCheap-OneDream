                ...
                <tbody>
                  @foreach($notifications as $notification)
                    <tr>
                      ...
                      <td class="px-1" >{{ $notification->created_at->format('Y-m-d') }}</td>
                      <td class="px-1">{{ $notification->updated_at->format('Y-m-d') }}</td>
                      <td>
                        <form action="" method="POST" class="toggle-status-form" data-notification-id="{{ $notification->notification_id }}">
                          @csrf
                          <button type="button" class="btn btn-sm {{ $notification->status == 1 ? 'text-primary' : 'text-secondary' }}" style="position: relative;">
                            <i class="fas {{ $notification->status == 1 ? 'fa-eye' : 'fa-eye-slash' }}"></i>
                            <span class="tooltip-text eye">{{ $notification->status == 1 ? 'Show' : 'Hide' }}</span>
                          </button>
                        </form>
                      </td>
                      <td>
                        ...
                        <form id="deleteForm_{{ $notification->notification_id }}" action="" method="POST" style="display: inline;">
                          @csrf
                          @method('DELETE')
                          <div class="icon-wrapper">
                            <button type="button" class="delete-btn border-0 p-0 btn text-danger" data-notification-id="{{ $notification->notification_id }}">
