        ...
        <div class="app-ecommerce" data-select2-id="21">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                ...
                <form
                    ...
                    action="{{ route('vip-packages.store')}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-6 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="package_name" placeholder="Package name" name="name" aria-label="Package name"
                                        {{-- @isset($dataStaffID)
                                ...
                                <div class="mb-6 col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="price" placeholder="price" name="price" aria-label="price"
                                        {{-- @isset($dataStaffID)
                                ...
                                <div class="mb-6 col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="duration" placeholder="duration" name="duration" aria-label="duration"
                                        {{-- @isset($dataStaffID)
                            ...
                            <div class="row ">
                                <div class="mb-6 col-md-4">
                                    ...
                                    <textarea type="text" class="form-control" id="description" placeholder="description" name="description"  aria-label="description"
                                        {{-- @isset($dataStaffID)
                            ...
                            <div class="card mb-6">
                                ...
                                @foreach ($vipPackages as $item )
                                            ...
                                            <tr>
                                                <td>
                                                    <div>
                                                    <span class="badge bg-info my-1">ID: {{ $item ->vip_package_id }}</span>
                                                    </div>
                                                    <div>
                                                        <span class="badge bg-info my-1">{{ date('D, d M Y', strtotime($item->created_at)) }}</span>
                                                        </div>
                                                </td>
                                                <td>{{ $item ->name }}</td>
                                                <td>
                                                ...
                                                <td>  <div class="container">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li data-bs-toggle="modal" data-bs-toggle="modal" data-bs-target="#modal{{ $item->vip_package_id }}">
                                                        <a class="dropdown-item" href="#"><span><i class="fa-solid fa-eye me-1"></i></span>View</a>
                                                        </li>
                                                    @if ( $item->status == 0)
                                                    <li onclick="confirmCheckLock(event,{{ $item->vip_package_id }})">
                                                        <a class="dropdown-item"><span style="padding-right: 10px"><i class="fa-solid fa-unlock"></i></span>Unlock</a>
                                                        <form id="check-lock-form-{{ $item->vip_package_id }}" action="{{ route('upU.Vip',$item->vip_package_id ) }}" method="POST" style="display:none;">
                                                            @csrf
                                                            @method('PUT')
                                                        </form>
                                                    @else
                                                    <li onclick="confirmCheckLock(event, {{ $item->vip_package_id }})">
                                                        <a class="dropdown-item" ><span style="padding-right: 10px"><i class="fa-solid fa-lock"></i></span>Locked</a>
                                                    <form id="check-lock-form-{{ $item->vip_package_id }}" action="{{ route('upL.Vip',$item->vip_package_id ) }}" method="POST" style="display:none;">
                                                        @csrf
                                                        @method('PUT')
                                                    </form>
                                                    ...
                                                    <div class="modal fade" id="modal{{ $item->vip_package_id }}" tabindex="-1" aria-labelledby="exampleModalLabel{{ $item->vip_package_id }}" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel{{ $item->vip_package_id }}">package details</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-5 mx-2">
                                                                                    ...
                                                                                    <p><strong>Duration:</strong><br>{{ $item -> duration }}-Day</p>
                                                                                    <p><strong>Price:</strong><br>${{ number_format($item->price, 2) }}</p>
