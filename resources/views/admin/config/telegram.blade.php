                            ...
                            <div class="card mb-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" class="form-control" id="chatID" placeholder="Chat ID"
                                            name="chatID"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 1. Use <a
                                                                    ...
                                                                    here </a> to create a bot and get the token. </span>
                                                        </div>
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 2. Create a new Telegram
                                                                group and add your bot to the group. </span> </div>
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 3. Send a message to the
                                                                group before proceeding to the next step. </span> </div>
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 4. Once you have the bot
                                                                token, prepare the URL in the following format:
                                                                <code>https://api.telegram.org/bot[BOT_TOKEN]/getUpdates</code>.
                                                            </span> </div>
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 5. Replace [BOT_TOKEN]
                                                                in the URL with your bot token (replace the entire
                                                                [BOT_TOKEN] placeholder with your actual bot token). For
                                                                example, if your bot token is
                                                                <code>66232322283:AAEadassdasdasdasdasdOOE</code>, the
                                                                corresponding URL will be
                                                                <code>https://api.telegram.org/bot66232322283:AAEadassdasdasdasdasdOOE/getUpdates</code>.
                                                            </span> </div>
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 6. Paste the prepared
                                                                URL from step 4 into a new browser tab. </span> </div>
                                                        <div class="ant-space-item py-1"> <span
                                                                class="ant-typography css-14brfei"> 7. Retrieve the group ID
                                                                as shown in the image below. Note: Make sure to copy the
