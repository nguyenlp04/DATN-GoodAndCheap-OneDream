            ...
            <div class="summary ">
                    <div class="profile">
                        ...
                        <img src="{{ asset(auth()->user()->image_user) }}"  alt="Profile Image" />
                            @else
                            <img src="https://kynguyenlamdep.com/wp-content/uploads/2022/06/anh-gai-xinh-cuc-dep.jpg"  alt="Profile Image" />
                            @endif
                        <span><h6 class="text-black p-3">{{ auth()->user()->full_name }}</h6>
                        </span>
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" id="tabs-2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-5-tab" data-toggle="tab" href="#tab-5" role="tab" aria-controls="tab-5" aria-selected="true">NOW SHOWING ({{ $count_now_showing }})</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-6-tab" data-toggle="tab" href="#tab-6" role="tab" aria-controls="tab-6" aria-selected="false">PENDING APPROVAL ({{ $count_pending_approval }})</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-7-tab" data-toggle="tab" href="#tab-7" role="tab" aria-controls="tab-7" aria-selected="false">NOT ACCEPTED ({{ $count_not_accepted }})</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-8-tab" data-toggle="tab" href="#tab-8" role="tab" aria-controls="tab-8" aria-selected="false">HIDDEN ({{ $count_hidden }})</a>
                            </li>
                        </ul>
                                ...
                                <div class="listing-card">
                                    ...
                                    <div class="card-content mb-2">
                                        <div class="container p-3">
                                            <div class="row">
                                                <div class="col-5"><div style="display: flex">
                                                    <img src="{{ asset($item->firstImage->image_name) }}" width="50px"  alt="" srcset="">
                                        <h2>{{ $item->title }}</h2>
                                    </div>
                                    ...
                                    <div class="col-5">
                                        ...
                                        <b><p class="services">{{ $item->vipPackage->name }}</p></b>
                                        @else
                                        ...
                                        <a href="{{ route('salenew.detail',$item->sale_new_id ) }}" class="btn btn-primary btn-rounded">Detail</a>
                                        <a href="{{ route('salenew.promote', $item->sale_new_id ) }}" class="btn btn-primary btn-rounded">Push to the top </a>
