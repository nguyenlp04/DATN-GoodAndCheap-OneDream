            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-2 mb-lg-0">
                        ...
                        <p class="mb-3">Good & Cheap is a newly established second-hand shopping website, offering quality
                            products at affordable prices. During operation, if there are any errors, we hope to receive
                            your understanding and suggestions. Your contribution will help us improve every day.
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="contact-form mb-3" enctype="multipart/form-data">
							@csrf <!-- Include CSRF token for security -->
							<div class="row">
								<div class="col-sm-6">
									<label for="name" class="sr-only">Name</label>
									<input type="tel" class="form-control" id="name" name="name" placeholder="Name">
								</div>
							...
							<textarea class="form-control" cols="30" rows="4" id="cmessage" name="cmessage" required placeholder="Message *"></textarea>
