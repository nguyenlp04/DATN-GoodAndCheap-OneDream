                                    ...
                                    <div class="header-dropdown" style="display: flex; align-items: center;">
                                        <a style="display: flex; align-items: center;">
                                            ...
                                            <div style="width: 40px; height: 40px; overflow: hidden; border-radius: 50%; margin-right: 10px;">
                                                <img
                                                    src="{{ Auth::user()->image_user ? asset(Auth::user()->image_user) : 'https://i.pinimg.com/originals/c6/e5/65/c6e56503cfdd87da299f72dc416023d4.jpg' }}"
                                                    alt="User Avatar"
                                                    style="width: 100%; height: 100%; object-fit: cover;">
                                            </div>
                                            <!-- Full Name -->
                                            <span class="highlight" style="white-space: nowrap;">{{ Auth::user()->full_name }}</span>
                                        </a>
                                        ...
                                        <div class="header-menu">
                                            <ul>
                                                <!-- Profile -->
                                                <li>
                                                    <a href="{{ route('account') }}">{{ __('Profile') }}</a>
                                                </li>

                                                <!-- My Channel (if exists) -->
                                                @if (auth()->user()->channel)
                                                <li>
                                                    <a href="{{ route('channels.index') }}">{{ __('My Channel') }}</a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('partners/profile') }}">{{ __('Channel Manager') }}</a>
                                                </li>
                                                @endif
                                                <!-- Logout -->
                                                <li>
