                ...
                <div class="header-right">
                    ...
                    <div class="dropdown cart-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right ">
                            ...
                            @for ($i = 0; $i < min(10, count($notifications)); $i++) <div
                                class="border-bottom border-secondary">
                                <a
                                    href="{{ route('notifications.detail', ['notification' => $notifications[$i]['notification_id']]) }}">
                                    <div>
                                        <h5 class="product-title">{{ $notifications[$i]['title_notification'] }}</h5>
                                        <span class="cart-product-info text-ellipsis">{!!
                                            Str::limit($notifications[$i]['content_notification'], 40) !!}</span>
                                        @php
                        ...
                        <div class="dropdown-cart-action mt-2 flex justify-content-center">
                            <a href="{{ route('notifications.show') }}" class="btn btn-outline-primary-2"><span>View
                                    All</span><i class="icon-long-arrow-center"></i></a>
